    ...
    public static GridPane createFilterBar() {
        ...
        filterButton.setOnAction(e -> {
            if (!filterInput.getText().equals("")) {
                //TODO Filter with filterInput buttons String. Filtering happens in referenceDAO(when it gets merged).
                //Make the Map for database here if possible.
            } else {
                //TODO Filter references so that all the references are shown.
            }
        });
